...
//        HandCards threshold;
//        threshold.add(Poker(DIAMONDS, six));
//        threshold.add(Poker(SPADES, six));
...
//            {
//                HandCards temp;
//                temp.Shuffle(2, known_cards);
//                temp.GetFromOther(copy_community);
//                temp.CalcMax();
